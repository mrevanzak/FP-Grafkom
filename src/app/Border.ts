...
export class Border {
  ...
  public placeBorder() {
    this.border1.position.set(-27.6, 0.6, 25.25);
    this.border1.scale.set(5, 5, 5);
    this.border1.rotation.y = Math.PI / 2;
    this.scene.add(this.border1);

    this.border2.position.set(26, 0.6, 27);
    this.border2.scale.set(5, 5, 5);
    this.border2.rotation.y = Math.PI;
    this.scene.add(this.border2);

    this.border3.position.set(27.6, 0.6, -26);
    this.border3.scale.set(5, 5, 5);
    this.border3.rotation.y = -Math.PI / 2;
    this.scene.add(this.border3);

    this.border4.position.set(-26, 0.6, -28);
    this.border4.scale.set(5, 5, 5);
